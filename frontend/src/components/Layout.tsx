...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  // Buscar número WhatsApp conectado (uma vez)
  useEffect(() => {
    whatsappService.getConnectedInstance().then(instance => {
      if (instance?.phoneNumber) {
        setWhatsappNumber(instance.phoneNumber);
      }
    }).catch(() => {});
  }, []);
  ...
  return (
    <Container>
      ...
      {whatsappNumber && <WhatsAppFab
        href={`https://wa.me/${whatsappNumber}`}
        target="_blank"
        rel="noopener noreferrer"
        title={t('nav.whatsappContact', 'Chat with us on WhatsApp')}
      >
